...
function getSignFiles(){
  const projectSign = _path2.default.resolve(process.cwd(), "sign");
  const defaultSign = _path2.default.resolve(__dirname, "../sign");
  const debugSign = _fs2.default.existsSync(projectSign) ? projectSign : defaultSign;

  return {
    debug: {
      privatekey: _path2.default.join(debugSign, "debug/private.pem"),
      certificate: _path2.default.join(debugSign, "debug/certificate.pem")
    },
    release: {
